...
export class BrandService {
  ...
  _brand = {
    DASHBOARD: {
      META_TITLE: "Pobuca Converse Design Studio",
      // FAVICON_URL: "https://tiledesk.com/wp-content/uploads/2022/07/tiledesk_v13-300x300.png",
      FAVICON_URL: "assets/images/brand/pobuca-converse.png",
      CUSTOM_COMPANY_HOME_LOGO: false,
      COMPANY_LOGO_PLANET: "assets/images/brand/pobuca-converse.png",
      "privacy_policy_link_text": "Privacy Policy",
      "privacy_policy_url": "https://www.pobuca.com/privacy-policy/",
      "display_terms_and_conditions_link": true,
      "terms_and_conditions_url": "https://www.pobuca.com/",
      "display_dpa_link": true,
      "dpa_url": "https://www.pobuca.com/",
      "contact_us_email": "support@pobuca.com",
      ...
      "footer": {
        ...
        "followus_on_x_URL": "https://www.pobuca.com/",
        "display_followus_on_fb": true,
        "followus_on_fb_URL": "https://www.pobuca.com/",
        "display_followus_on_in": true,
        "followus_on_in_URL": "https://www.linkedin.com/company/pobuca/",
        "display_followus_on_instagram": true,
        "followus_on_instagram_URL": "https://www.pobuca.com/",
        "display_followus_on_youtube": true,
        "followus_on_youtube_URL": "https://www.pobuca.com/"
      },
      "recent_project_page": {
      ...
      "handle_invitation_page": {
        "company_logo_45x45": "assets/images/brand/pobuca-converse.png"
      },
    },
    WIDGET: {
      "LOGO_CHAT": "assets/images/brand/pobuca-converse.png",
      "POWERED_BY": "<a tabindex='-1' target='_blank href='https://www.pobuca.com/?utm_source=widget'><img src='assets/images/brand/pobuca-converse.png'/><span> Powered by Pobuca Converse</span></a>"
    },
    CHAT: {
    ...
    COMMON: {
      COMPANY_LOGO: "assets/images/brand/pobuca-converse.png",
      COMPANY_LOGO_NO_TEXT: "assets/images/brand/pobuca-converse.png",
      BASE_LOGO: "assets/images/brand/pobuca-converse.png",
      BASE_LOGO_NO_TEXT: "assets/images/brand/pobuca-converse.png",
      COMPANY_NAME: "Pobuca Converse",
      BRAND_NAME: "Pobuca Converse",
      COMPANY_SITE_NAME: "pobuca.com",
      COMPANY_SITE_URL: "https://www.pobuca.com",
      CONTACT_US_EMAIL: "support@pobuca.com",
      CONTACT_SALES_EMAIL: "sales@pobuca.com",
